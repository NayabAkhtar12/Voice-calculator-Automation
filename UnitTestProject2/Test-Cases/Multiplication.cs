...
namespace UnitTestProject2
{
    ...
    public class Multiplication :Baseclass
    {
        ...
        public void MultiplicationOp()
        {
            ...
            string BasicMultiplicationResult = driver.FindElementById("com.voice.calculator.qr.scanner.scientificcalculator.qrcode.barcode.reader:id/resultEditText").Text;
            ...
            driver.FindElementById("com.voice.calculator.qr.scanner.scientificcalculator.qrcode.barcode.reader:id/equal").Click();
            // Expected Result: (-2.5) * (-1.5) = 3.75
            string MultiplyNegativeDecimalsResult = driver.FindElementById("com.voice.calculator.qr.scanner.scientificcalculator.qrcode.barcode.reader:id/resultEditText").Text;
            ...
            string NegPosDecMultiplicationResult = driver.FindElementById("com.voice.calculator.qr.scanner.scientificcalculator.qrcode.barcode.reader:id/resultEditText").Text;
            ...
            Assert.AreEqual("8.879", largeNumberDivisionResult);
            driver.FindElementById("com.voice.calculator.qr.scanner.scientificcalculator.qrcode.barcode.reader:id/clearScreen").Click();
